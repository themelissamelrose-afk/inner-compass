...
app.get('/pisces-meditation', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'pisces-meditation.html'));
});

app.get('/full-moon-journal', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'full-moon-journal.html'));
});
...
app.get('/reaction-portal', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'reaction-portal.html'));
});
app.get('/heart-awakening', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'heart-awakening.html'));
});
app.get('/reveal-your-patterns', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'reveal-your-patterns.html'));
});
...
app.get('/reset-audio', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'reset-audio.html'));
});
...
app.get('/kids-daily-feels', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'kids-daily-feels.html'));
});

app.get('/kids-hello-body', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'kids-hello-body.html'));
});
